  ...
  <div class="json-lab">
    ...
    <section class="lab-section">
      ...
      <ul>
        <li v-for="author in authors" :key="author.id">
          <p v-if ="author.name === searchName" :style="{color :highlightColor , fontSize :fontSize + 'px'}">
    ...
    <section class="lab-section">
      ...
      <!-- TODO: CODE TO RENDER LIST OF OPENING HOURS HERE -->
       <ul>
        <li v-for="timing, days in bookstores.openingHours" :key="days">
          <p>{{ days }}</p>
          <p>{{ timing.open }} : {{ timing.close }}</p>
        </li>
       </ul>
      ...
      <p>Our #1 seller:</p>
      <p v-for = "books in bookstores.topSellers" :key= "books">
        {{ books }}
      </p>
    </section>
    ...
    <section class="lab-section" :class="{active :isActive}">
...
const modernAuthors = computed(() => {
  ...
  //console.log(authors.filter((author) => author.birthYear > 1850))
})
